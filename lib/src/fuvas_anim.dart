...
import 'package:pediasure_flutter/src/mixin.dart';
...
class Forty extends Funvas with Mixin {
  @override
  String get tweet =>
      'https://twitter.com/creativemaybeno/status/1439265804709679111?s=20';

  static const _d = 500.0, _r = 30.0;
  static const _nl = 2, _dpl = 10;
  ...
  void u(double t) {
    ...
    if (_layers.isEmpty) {
      for (var i = 0; i < _nl; i++) {
        final color =
            i % 2 == 0 ? const Color(0xff622781) : const Color(0xFF592276);
